...
import { getTrailerTypes, getVehicleTypes } from '../../../../fetch/getTrailersAndVehicleTypes'
import { FILTER } from '../../../../global'
import { AdvancedSearch } from '../../../../table/TableColumns/AdvancedSearch/AdvancedSearch'
import * as styles from '../../../../table/TableStyles.css'
...
/// Table Component
export function TableAdm({ data, columns, updateTableData, filterType, searchInTable }: { data, columns, updateTableData?: (updatedData) => void, filterType?: string, searchInTable?: boolean }) {
  ...
  return (
    <>
      {((data === undefined) || (data.length === 0))
        ? <h1 className={styles.h1}>No Hay Información Para Mostrar</h1>
        : (
          <div>
