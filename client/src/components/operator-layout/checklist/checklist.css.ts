...
export const containerStyle = style({
  display: 'flex',
  flexDirection: 'row',
  flexWrap: 'nowrap', // Cambia a 'wrap' si quieres que los elementos se ajusten en múltiples líneas
  justifyContent: 'space-between', // Ajusta según sea necesario, por ejemplo 'center' o 'space-around'
  alignItems: 'center', // Ajusta según sea necesario, por ejemplo 'flex-start' o 'flex-end'
})
...
export const iconChecklistFalse = style({
  'marginTop': '0.2rem',
  'padding': '0.5rem',
  'fontSize': '1rem',
  'backgroundColor': '#fa040463',
  'color': vars.colors.green900,
  'borderRadius': '999999px',
  ':hover': {
    boxShadow: '0px 2px 2px black',
...
export const closeButtonSignature = style({
  'border': '2px solid',
  'borderColor': vars.colors.principal,
...
export const saveButtonSignature = style({
  'backgroundColor': vars.colors.principal,
  'color': vars.colors.color,
  'width': '20%',
